        ...
        <div class="container">
            <div class="row">
                <div class="header-top-right col-lg-12 col-md-12 col-sm-6 col-xs-6">
                    ...
                    <div class="hidden-lg account" id="my_account">
        ...
        <div class="container">
            <div class="row">
                <div class="navbar-logo col-lg-2 col-md-3 col-sm-12 col-xs-12">
                    <div class="logo">
                        <a href="{{URL::to('/')}}">
                            <img class="lazyload"  src="{{asset($setting->logo)}}" data-src="{{asset($setting->logo)}}" title="{{$setting->company_name}} " alt="{{$setting->company_name}}" style="width: 175px;margin-top: -10px" /></a>
                    </div>
                </div>
