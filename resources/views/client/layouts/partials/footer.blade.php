            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 copyright-w">
                    <div class="copyright0">
                        <h5 class="copyright-title text-center">{{$setting->company_name}} {{$setting->copyright}} All Rights Reserved. Designed by <a href="{{url('/')}}" target="_blank" type="{{$setting->company_title}} ">{{$setting->company_name}} </a></h5>
                    </div>
                </div>
