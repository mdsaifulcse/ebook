    ...
    <div id="account-register" class="container">
        ...
        <div class="row">
            <div id="content" class="col-sm-9 ">
                ...
                {!! Form::open(array('route' => 'register','method'=>'POST','class'=>'form-horizontal','files'=>false,'style'=>'padding-bottom:25px;')) !!}
                    <fieldset id="account">
                ...
                <div class="form-group ">
                    ...
                    <div class="col-sm-8 text-right">
                        If you already have an account with us, please login at the <a href="#" data-target="#so_sociallogin" data-toggle="modal" class="btn btn-default">login page</a>
