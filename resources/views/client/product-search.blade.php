...
<script src="{{asset('/client/assets')}}/javascript/jquery/jquery-2.1.1.min.js"></script>
    <div class="breadcrumbs ">
        <div class="container">
            <div class="current-name"> {{$categoryData?$categoryData->category_name:''}}</div>
            <ul class="breadcrumb">
                <li><a href="{{URL::to('/')}}"><i class="fa fa-home"></i></a></li>
                <li><a href="{{URL::to('products/category/'.$categoryData??$categoryData->link)}}">{{$categoryData?$categoryData->category_name:''}}</a></li>
            </ul>
        </div>
    </div>
            ...
            <div id="content" class="col-md-9 col-sm-12 col-xs-12 fluid-sidebar">
                ...
                <div class="products-category clearfix">
                    {{--<div class="refine-search form-group clearfix">--}}
                        ...
                        {{--</ul>--}}
                    {{--</div>--}}
                    <h3 class="title-category ">{{$categoryData?$categoryData->category_name:''}}</h3>
